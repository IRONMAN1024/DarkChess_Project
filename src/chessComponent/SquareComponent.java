...
public abstract class SquareComponent extends JComponent {
    ...
    public static final Color squareColor = new Color(250 , 231 , 190 , 255);
    ...
    public static int spacingLength;
    protected static final Font CHESS_FONT = new Font("楷体", Font.BOLD, 36);

    public int chessComponentNum;
    public int chessComponentScore;
...
//        GameController.GameFile.add("repaint chess ["+chessboardPoint.getX()+","+chessboardPoint.getY()+"]\n");
